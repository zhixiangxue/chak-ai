...
class MoonshotMessageConverter(BaseMessageConverter):
    ...
    def from_provider_response(self, response: Any) -> AIMessage:
        """Convert Moonshot response to standard AIMessage."""
    ...
    def from_provider_chunk(self, chunk: Any) -> MessageChunk:
        """Convert Moonshot streaming chunk to standard MessageChunk."""
...
class MoonshotProvider(Provider):
    ...
    def _send_complete(self, messages: List, **kwargs) -> Any:
        """Send non-streaming request to Moonshot."""
    ...
    def _send_stream(self, messages: List, **kwargs) -> Iterator[Any]:
        """Send streaming request to Moonshot."""
