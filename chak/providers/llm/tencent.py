...
class TencentMessageConverter(BaseMessageConverter):
    ...
    def from_provider_response(self, response: Any) -> AIMessage:
        """Convert Tencent Cloud response to standard AIMessage."""
    ...
    def from_provider_chunk(self, chunk: Any) -> MessageChunk:
        """Convert Tencent Cloud streaming chunk to standard MessageChunk."""
...
class TencentProvider(Provider):
    ...
    def _send_complete(self, messages: List, **kwargs) -> Any:
        """Send non-streaming request to Tencent Cloud."""
    ...
    def _send_stream(self, messages: List, **kwargs) -> Iterator[Any]:
        """Send streaming request to Tencent Cloud."""
