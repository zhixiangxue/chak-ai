...
class SiliconFlowMessageConverter(BaseMessageConverter):
    """Converter for SiliconFlow message formats."""
    
    def to_provider_format(self, messages: List[Message]) -> List[Dict[str, Any]]:
        """Convert to SiliconFlow message format (OpenAI compatible)."""
        return [
            {
    ...
    def from_provider_response(self, response: Any) -> AIMessage:
        """Convert SiliconFlow response to standard AIMessage."""
    ...
    def from_provider_chunk(self, chunk: Any) -> MessageChunk:
        """Convert SiliconFlow streaming chunk to standard MessageChunk."""
...
class SiliconFlowProvider(Provider):
    ...
    def _send_complete(self, messages: List, **kwargs) -> Any:
        """Send non-streaming request to SiliconFlow."""
    ...
    def _send_stream(self, messages: List, **kwargs) -> Iterator[Any]:
        """Send streaming request to SiliconFlow."""
