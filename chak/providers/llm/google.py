...
class GoogleMessageConverter(BaseMessageConverter):
    ...
    def to_provider_format(self, messages: List[Message]) -> List[Dict[str, Any]]:
        """Convert to Google AI message format (OpenAI compatible)."""
        return [
            {
    ...
    def from_provider_response(self, response: Any) -> AIMessage:
        """Convert Google AI response to standard AIMessage."""
    ...
    def from_provider_chunk(self, chunk: Any) -> MessageChunk:
        """Convert Google AI streaming chunk to standard MessageChunk."""
...
class GoogleProvider(Provider):
    ...
    def _send_complete(self, messages: List, **kwargs) -> Any:
        """Send non-streaming request to Google AI."""
    ...
    def _send_stream(self, messages: List, **kwargs) -> Iterator[Any]:
        """Send streaming request to Google AI."""
