...
Provides reusable base classes for any provider that exposes an OpenAI-compatible API.
Used by: OpenAI, DeepSeek, Azure, Google, xAI, Mistral, Moonshot, SiliconFlow,
VolcEngine, Tencent, Zhipu, iFlytek, Baidu, Ollama, vLLM.
"""
...
from ...message import Message, AIMessage, ChatCompletionMessageToolCall, Function, UnifiedStreamChunk
