...
配置方式：
    通过环境变量配置：
    - CHAK_LOG_LEVEL: 日志级别（DEBUG/INFO/WARNING/ERROR）默认 INFO
    - CHAK_LOG_TO_FILE: 是否输出到文件（true/false）默认 false
    - CHAK_LOG_FILE: 日志文件路径，默认 logs/chak.log
"""
...
LOG_FILE = os.getenv("CHAK_LOG_FILE", "logs/chak.log")
